...
SWEP.PrintName			= "Dual Colt SAA 'Peacemaker'"		// 'Nice' Weapon name (Shown on HUD)	
...
if (file.Exists("materials/weapons/weapon_mad_fof_dualpeacemaker.vmt","GAME")) then
	SWEP.WepSelectIcon	= surface.GetTextureID("weapons/weapon_mad_fof_dualpeacemaker")
end
