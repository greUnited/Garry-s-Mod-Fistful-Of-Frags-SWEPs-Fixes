...
SWEP.Primary.Sound 		= Sound("Weapom_HenryRifle.Single")
...
SWEP.IronSightsPos 		= Vector (-4.2684, -7.9398, 3.2623)
SWEP.IronSightsAng 		= Vector (-0.06, 0.005, 0)
...
function SWEP:PrimaryAttack()
	...
	timer.Simple(0.45, function()
		...
		self.Weapon:EmitSound("Weapom_HenryRifle.Lever")
