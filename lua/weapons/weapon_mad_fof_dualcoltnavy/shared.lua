...
SWEP.ViewModel			= "models/weapons/v_dualnavy.mdl"
SWEP.WorldModel			= "models/weapons/w_dualnavy.mdl"
SWEP.HoldType				= "duel"
SWEP.Spawnable			= true
SWEP.AdminSpawnable		= false

SWEP.Primary.Sound 		= Sound("Weapom_ColtNavy.Single")
...
SWEP.Primary.Ammo			= "thirtysixball"
