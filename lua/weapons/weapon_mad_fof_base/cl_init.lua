...
language.Add("fourtyfour_ammo", ".44 Caliber Ammo")						
language.Add("shotgunshell_ammo", "12 Gauge Shells")				
language.Add("fourtyfivecolt_ammo", ".45 Colt Ammo")				
language.Add("fiftysmith_ammo", ".50 Caliber Smith Ammo")
language.Add("fourtyfiveseventy_ammo", ".45-70 Ammo")
language.Add("thirtysixball_ammo", ".36 Ball Ammo")	
language.Add("fourtyone_ammo", ".41 Derringer Ammo")
language.Add("bow_ammo", "5.56mm Nato Ammo")
